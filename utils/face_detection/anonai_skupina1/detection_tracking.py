...
def camshift_tracker(v, file_name):
    ...
    res, frame_blurred, face_boxes = fd.detect_face_video_frame(frame, fd.detection_model_init(model_path))
    #c,r,w,h = detect_one_face(frame)  #x,y,w,h
    c, r, w, h = face_boxes[0]
